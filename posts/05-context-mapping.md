...
- **Ngôn ngữ của bạn bị chiếm đóng**: team bạn sẽ *nói* bằng từ vựng của vendor. Domain expert nói "khách đặt cọc", code nói `PaymentIntent` — khoảng cách ngôn ngữ này chính là thứ [chương 03](#/post/03-ubiquitous-language) cảnh báo, và nó âm thầm định hình cách team *nghĩ* về nghiệp vụ.
...
- Strangler fig khi refactor legacy (chương [14](#/post/14-ddd-trong-production)): ACL là công cụ số một để hệ mới sống cạnh hệ cũ mà không nhiễm model cũ.
